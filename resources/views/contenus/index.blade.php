            ...
            <tbody>
                @forelse($contenus as $contenu)
                    <tr>
                        ...
                        <td>{{ $contenu->type->libelle ?? '-' }}</td>
                        <td>{{ $contenu->region->nom_region ?? '-' }}</td>
                        

                        <td class="text-center">
                        <a href="{{ route('contenus.show', $contenu->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-eye"></i>
                        </a>
                ...
                @empty
                    <tr><td colspan="5" class="text-center">Aucun contenu disponible.</td></tr>
                @endforelse
            </tbody>
