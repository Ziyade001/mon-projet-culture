    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="{{ route('utilisateurs.show', $utilisateur) }}">{{ $utilisateur->nom_complet }}</a></li>
...
<div class="container-fluid">
    ...
    <div class="card shadow border-0">
        <div class="card-header bg-white">
            <h4 class="card-title mb-0 fw-bold">Modifier l'utilisateur</h4>
        </div>
        ...
        <form method="POST" action="{{ route('utilisateurs.update', $utilisateur) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3 text-center">
                            ...
                            <div class="mt-2">
                                <a href="#" onclick="document.getElementById('remove-photo').value = '1'; document.getElementById('current-photo').classList.add('d-none');" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_naissance') is-invalid @enderror" 
                                       id="date_naissance" name="date_naissance" value="{{ old('date_naissance', $utilisateur->date_naissance ? $utilisateur->date_naissance->format('Y-m-d') : '') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="est_actif" name="est_actif" value="1" 
                                       {{ old('est_actif', $utilisateur->est_actif) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('adresse') is-invalid @enderror" 
                                   id="adresse" name="adresse" value="{{ old('adresse', $utilisateur->adresse) }}">
                            @error('adresse')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('ville') is-invalid @enderror" 
                                       id="ville" name="ville" value="{{ old('ville', $utilisateur->ville) }}">
                                @error('ville')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('pays') is-invalid @enderror" 
                                       id="pays" name="pays" value="{{ old('pays', $utilisateur->pays) }}">
                                @error('pays')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('code_postal') is-invalid @enderror" 
                                   id="code_postal" name="code_postal" value="{{ old('code_postal', $utilisateur->code_postal) }}">
                            @error('code_postal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror" 
                                      id="bio" name="bio" rows="3">{{ old('bio', $utilisateur->bio) }}</textarea>
                            @error('bio')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card-footer bg-white d-flex justify-content-between">
                <a href="{{ route('utilisateurs.show', $utilisateur) }}" class="btn btn-secondary">
                    <i class="bi bi-arrow-left me-1"></i> Annuler
                </a>
                <div>
                    <a href="{{ route('utilisateurs.show', $utilisateur) }}" class="btn btn-outline-secondary me-2">
